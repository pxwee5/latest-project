...
;(function ($, window, document, undefined) {
	...
	$.extend(Plugin.prototype, {
		 ...
		 */
		createMarker: function (point, name, address, letter, map, category, id) {
			...
			if (this.settings.callbackCreateMarker) {
				...
				marker = this.settings.callbackCreateMarker.call(this, map, point, letter, category, id);
			}
			else {
		...
		processData: function (mappingObject, originPoint, data, page) {
			...
			for (var y = 0; y <= storeNumToShow - 1; y++) {
				...
				marker = _this.createMarker(point, locationset[y].name, locationset[y].address, letter, _this.map, locationset[y].category, y+1);
				marker.set('id', y);
				markers[y] = marker;
				if ((_this.settings.fullMapStart === true && firstRun === true) || (_this.settings.mapSettings.zoom === 0) || (typeof origin === 'undefined') || (distError === true)) {
					bounds.extend(point);
